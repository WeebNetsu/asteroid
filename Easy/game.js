...
const FRICTION = 0.7; //gravity (0 = no graviry, 1 = a lot of gravity)
const GAME_LIVES = 3; //Player lives
const SAVE_KEY_SCORE = "highscore"; //save key for local storage of high score

const LAZER_MAX = 10; //Max num of lazers on screen
const LAZER_DIST = 0.7; //Max distance lazer can travel
...
const ROIDS_SPD = 50; //Max Starting speed of astroids
...
const ROIDS_PTS_MED = 30; //Medium astroid = +50pts
const ROIDS_PTS_SML = 50; //Small astroid = +100pts

const SHIP__DUR = 4; //ship is invinsible for 3 sec after crash
const SHIP_BLINK_DUR = 0.1; //how fast ship blinks when revived
const SHIP_EXPLOAD_DUR = 0.7; //ship explosion length
const SHIP_INV_DUR = 4; //ship is invinsible for 3 sec after crash
...
function update(){
	...
	if(ship.reversing && !ship.dead){ //reverse ship
		...
		ship.thrust.x -= FRICTION * ship.reverse.x / FPS;
		ship.thrust.y -= FRICTION * ship.reverse.y / FPS;
	}
